...
import 'package:hospital/models/my_appointement.dart';
import 'package:hospital/models/my_doctor.dart';
import 'package:hospital/models/my_user.dart';
...
await
   DataBaseUtils.addAppointmentToFirestore(appointment).timeout(const Duration(seconds: 1),
        onTimeout: () {
          Navigator.of(context).pushNamed(Appointments.routeName,).catchError((e) {
            print(e.message);
          });
 });
  }
